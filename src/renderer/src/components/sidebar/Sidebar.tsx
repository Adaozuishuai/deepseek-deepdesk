  ...
  return (
    <aside className='sidebar'>
      ...
      <div className='sidebar-scroll'>
        {filtered.length === 0 && (
          <div className='muted' style={{ textAlign: 'center', padding: '24px 8px', fontSize: 12 }}>
      ...
      <div className='sidebar-footer'>
        <div className='model-chip' onClick={onOpenSettings} title='当前默认模型服务，点击进入设置'>
          ...
          {configured && settings && <span className='muted mono' style={{ fontSize: 11 }}>{settings.defaultModelId}</span>}
        </div>
